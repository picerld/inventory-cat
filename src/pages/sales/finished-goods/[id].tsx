...
import { SaleFinishedGoodDetaiContainer } from "~/components/features/sales/finished-good/components/detail/SaleFinishedGoodDetailContainer";
...
export default function SaleFinishedGoodDetailPage() {
  ...
  return (
    <GuardedLayout>
      ...
      <SaleFinishedGoodDetaiContainer data={data} items={items} />
    </GuardedLayout>
  );
}
