...
import type { ActionKey } from "../../../types/forms";

type SaleFinishedGoodActionsSectionProps = {
  isSubmitting: boolean;
  initialData?: SaleFinishedGoodFull;
  mode: "create" | "edit";
...
export const SaleFinishedGoodActionsSection = ({
  isSubmitting,
  initialData,
  mode,
  canSetOngoing,
  ...
  setActiveAction,
  updateStatus,
}: SaleFinishedGoodActionsSectionProps) => {
  return (
    <Card>
      <CardHeader>
